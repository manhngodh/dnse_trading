...
async def place_order():
    ...
    # Best ask was 1.25, so price is 1250 VND
    price = Decimal("1250") 
    quantity = 100
    ...
    try:
        ...
        print(f"Placing BUY Limit Order: {quantity} {symbol} @ {price}...")
        
        # Using loanPackageId 1775 (Cash) as identified for this account type
